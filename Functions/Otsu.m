...
home_fld = '/Users/ashish/Documents/PhD/CT_Data/TAVR_Clinical_ResyncCT/';

patient = 'cvc1807171636';

% Folder where image is stored
img_path = [home_fld,patient,'/Input/img-nii/img_00.nii.gz'];
