...
info.seg_path = ['/Users/ashish/Documents/PhD/CT_Data/Fractal_paper_correlation/',...
    info.patient,'/seg-nii/'];       %Folder path containing the segmentations to read
info.img_path = ['/Users/ashish/Documents/PhD/CT_Data/Fractal_paper_correlation/',...
    info.patient,'/img-nii/'];       %Folder path containing the nii images to read for rotations
info.dcm_path = ['/Users/ashish/Documents/PhD/CT_Data/Stress-Rest/',...
    info.patient,'/Repro/Trial2/img-dcm/'];       %Folder path containing the dcm images to read for percent rr
...
% Time frame list
info.timeframes = 1:20;             %Desired time frames for analysis
